...
use crate::channel::input::{new_input, InputProxy};
use crate::channel::output::{OutputAbortNotify, OutputBuilder, OutputBuilderImpl, OutputProxy};
...
impl OperatorBuilder {
    ...
    pub(crate) fn add_input<T: Data>(
        &mut self, ch_info: ChannelInfo, pull: DataPlanePull<MicroBatch<T>>,
