...
use crate::output::streaming::batching::BufStreamPush;
use crate::output::streaming::partition::PartitionRoute;
use crate::output::unify::{BaseBatchPull, BufEventedBaseBatchPush, EnumStreamBufPush};
...
) -> Result<LinkedList<(Vec<BufEventedBaseBatchPush<T>>, BaseBatchPull<T>)>, IOError>
where
    T: Data + Encode + Decode,
{
